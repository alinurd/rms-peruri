...
function cari_ajax_singgle_del(tipe, data, url) {
	...
	$.ajax({
		...
		dataType: "json",
		success: function (msg) {
			pesan_toastr('Hapus data Berhasil', 'success', 'Sukses', 'toast-top-center', true)
...
function cari_ajax_combo_file(tipe, parent, data, target_combo, url, proses_result, sts_loading, tipe_result) {
	url = base_url + url;
	if (typeof (sts_loading) == "undefined")
		sts_loading = true;
	...
	if (typeof (proses_result) == "undefined")
		proses_result = "";
	if (typeof (tipe_result) == "undefined")
		tipe_result = "html";

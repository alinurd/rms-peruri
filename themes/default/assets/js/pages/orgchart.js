...
(OrgChart.prototype.load = function (t) {
            ...
            function (t) {
                ...
                for (var n in (OrgChart.events.publish("prerender", [y, e]), (r = e.content), t.visibleNodes)) {
                    var l = t.visibleNodes[n],
                        s = y._get(n);
                    (r += y.ui.node(l, s, t.animations, y.config, void 0, void 0, void 0, O, i, y)), (r += y.ui.link(l, y, y.config, i)), (r += y.ui.expandCollapse(y, l, y.config, O, i));
                }
                e = { content: r, res: t };
                if ((OrgChart.events.publish("render", [y, e]), (r = e.content), (r += y.ui.lonely(y.config)), O !== OrgChart.action.exporting)) {
                    ...
                    O === OrgChart.action.centerNode
                        ...
                        : !a ||
                          !y.response ||
                          (a[0] == y.response.viewBox[0] && a[1] == y.response.viewBox[1] && a[2] == y.response.viewBox[2] && a[3] == y.response.viewBox[3]) ||
                          (O !== OrgChart.action.insert && O !== OrgChart.action.expandCollapse && O !== OrgChart.action.update && O !== OrgChart.action.init)
                        ? 0 == g[0].length && (c || (x && x(), OrgChart.events.publish("redraw", [y]), (c = !0)))
                        : OrgChart.anim(y.getSvg(), { viewbox: a }, { viewbox: y.response.viewBox }, 500, OrgChart.anim.inOutPow, function () {
        ...
        if (null != i) {
            ...
            if (null != a) {
                ...
                C.setAttribute("x", v.ripple.rect ? v.ripple.rect.x : 0),
                    ...
                    f.appendChild(m),
                    a.appendChild(f),
                    OrgChart.anim(m, { r: 0, opacity: 1 }, { r: p, opacity: 0 }, 500, OrgChart.anim.outPow, function () {
                        a.removeChild(f);
                    });
            }
        }
    ...
    (OrgChart.prototype._hideBeforeAnimation = function (t) {
        if (1 != this._hideBeforeAnimationCompleted && !(t && t < OrgChart.ANIM_THRESHOLD)) {
            ...
            if (o.length > OrgChart.EXPCOLL_THRESHOLD) for (r = 0; r < o.length; r++) o[r].style.display = "none";
    ...
    (OrgChart.prototype.group = function (t, e, r, i) {
        ...
        if (a.isGroup || o.isGroup || a.isChildOfGroup || o.isChildOfGroup)
            if (a.isGroup || o.isGroup || !a.isChildOfGroup || o.isChildOfGroup)
                if (a.isGroup || o.isGroup || a.isChildOfGroup || !o.isChildOfGroup)
                    if (!a.isGroup && !o.isGroup && a.isChildOfGroup && o.isChildOfGroup)
                        a._groupParentNodeId != o._groupParentNodeId &&
                            (this._removeGroupIfHasOneNode(a._groupParentNodeId, a.id), this.removeNodeTag(a.id, a._groupParentNodeId, !0), this.addNodeTag(a.id, o._groupParentNodeId, !0), this.link(a.id, o.pid));
                ...
                this.addTag(s, { group: !0, groupName: "", groupState: OrgChart.EXPAND, template: "group_grey" }, !0),
            ...
            this.addTag(s, { group: !0, groupName: "", groupState: OrgChart.EXPAND, template: "group_grey" }, !0), this.addNodeTag(a.id, s, !0), this.addNodeTag(o.id, s, !0);
    ...
    (OrgChart._addPointTop = function (t, e, r, i, a) {
        ...
        return (
            "left" == a
                ? (o = t.leftNeighbor ? t.x + (t.leftNeighbor.x + t.leftNeighbor.w - t.x) / 2 : t.x - r.siblingSeparation / 2)
                : "right" == a && (o = t.rightNeighbor ? t.x + t.w + (t.rightNeighbor.x - (t.x + t.w)) / 2 : t.x + t.w + r.siblingSeparation / 2),
    ...
    (OrgChart._addPointLeft = function (t, e, r, i, a) {
        ...
        return (
            "bottom" == a
                ? (o = t.rightNeighbor ? t.y + t.h + (t.rightNeighbor.y - (t.y + t.h)) / 2 : t.y + t.h + r.siblingSeparation / 2)
                : "top" == a && (o = t.leftNeighbor ? t.y + (t.leftNeighbor.y + t.leftNeighbor.h - t.y) / 2 : t.y - r.siblingSeparation / 2),
    ...
    (OrgChart.editUI.prototype._createEditView = function (t, e) {
        ...
        (l.className = "edit-assistant-button-content"),
            ...
            Object.assign(o.style, { margin: "14px 14px 7px", color: "#4285F4", cursor: "pointer" }),
        ...
        t.isGroup || t.isChildOfGroup || 0 != t.childrenIds.length || this._addField(n, l, "isAssistant", "edit"),
            ...
            o.addEventListener("click", function () {
                if ("Save" == o.innerHTML)
                    OrgChart.anim(o, { opacity: 1 }, { opacity: 0 }, 200, OrgChart.anim.inSin, function () {
                        ...
                        OrgChart.anim(o, { opacity: 0 }, { opacity: 1 }, 200, OrgChart.anim.inSin);
                    });
                else {
                    OrgChart.anim(o, { opacity: 1 }, { opacity: 0 }, 200, OrgChart.anim.inSin, function () {
                        (o.innerHTML = "Save"), (o.style.textAlign = "right"), OrgChart.anim(o, { opacity: 0 }, { opacity: 1 }, 200, OrgChart.anim.inSin);
                    });
                    ...
                    if (a) {
                        ...
                        if (a === OrgChart.TAGS) e.tags = o.split(",");
                            ...
                            n && e.tags
                                ...
                                : n && !e.tags
                                ? (e.tags = ["assistant"])
                                : !n && e.tags && -1 != this.node.tags.indexOf("assistant") && e.tags.splice(e.tags.indexOf("assistant"), 1);
                        ...
                        if (void 0 === l[r].onClick)
                            if ("add" === r) {
                                ...
                                "remove" === r
                                    ...
                                    : "svg" === r
                                    ? s.obj.exportSVG({ filename: "OrgChart.svg", expandChildren: !1, nodeId: o })
                                    : "pdf" === r
                                    ? s.obj.exportPDF({ filename: "OrgChart.pdf", expandChildren: !1, nodeId: o })
                                    : "png" === r
                                    ? s.obj.exportPNG({ filename: "OrgChart.png", expandChildren: !1, nodeId: o })
                                    : "csv" === r
                                    ? s.obj.exportCSV()
                                    : "xml" === r
                                    ? s.obj.exportXML()
    ...
    (OrgChart.notifierUI.prototype.show = function (t, e) {
        if (null != t) {
            ...
            var o = r.offsetWidth;
            (r.style.width = "20px"), OrgChart.anim(r, { opacity: 0, width: 10 }, { opacity: 1, width: o }, this.obj.config.anim.duration, this.obj.config.anim.func);
        }
    }),
    (OrgChart.icon = {}),
    ...
    (OrgChart.prototype._pages = function (t, e, r) {
        ("A4" == t.format && "fit" != t.scale) || ("A3" == t.format && "fit" != t.scale) || ("A2" == t.format && "fit" != t.scale) || ("A1" == t.format && "fit" != t.scale)
    ...
    (OrgChart.prototype._pagesAfit = function (t, e) {
        ...
        var o = t.landscape ? a - (t.margin[1] + t.margin[3]) : i - (t.margin[1] + t.margin[3]),
            n = (t.landscape ? (t.margin[0], t.margin[2]) : (t.margin[0], t.margin[2]), o / r);
    ...
    (OrgChart.prototype._pagesA100 = function (t, e, r) {
        ...
        var n = i[0],
            ...
            s = i[2],
            h = i[3],
            d = { w: t.landscape ? o - (t.margin[1] + t.margin[3]) : a - (t.margin[1] + t.margin[3]), h: t.landscape ? a - (t.margin[0] + t.margin[2]) : o - (t.margin[0] + t.margin[2]) },
        ...
        for (var g = n, p = l, f = d.w * (100 / r) - n, u = d.h * (100 / r), C = []; g < s - 1; ) {
            for (; p < h - 1; ) {
                var m = [g, p, g + f, u];
                (m = m.join()), C.push({ vb: m, innerSize: d, size: c }), (p += u - l);
            }
            (g += f), (p = l);
        }
        return C;
                    ...
                    if (0 < r.length) {
                        ...
                        for (i = 0; i < r.length; i++)
                            1 == e.length
                                ...
                                : 5 == e.length && (o = r[i](e[0], e[1], e[2], e[3], e[4]) && o);
                        return o;
                    }
                }
            },
    ...
    (OrgChart.prototype._nodeMouseDownHandler = function (t, e, n) {
        if (this.config.enableDragDrop) {
            ...
            if (!1 !== OrgChart.events.publish("drag", [this, i])) {
                ...
                var m = this,
                    O = this.getSvg();
                O.classList.add("cursor-grab"), O.classList.remove("cursor-move");
                var v = { x: r.x, y: r.y },
                    ...
                    w = m.getScale(),
                    _ = t.cloneNode(!0);
                if ((O.insertBefore(_, O.firstChild), (_.style.opacity = 0.7), l.isChildOfGroup)) {
                    var a = this.getNodeElement(l._groupParentNodeId),
                        o = OrgChart._getTransform(a);
                    (y += o[4]), (b += o[5]), (x[4] = y), (x[5] = b), _.setAttribute("transform", "matrix(" + x.toString() + ")");
                }
                var k = function (t, e) {
                        if (null != t) {
                            var r = m.getBGNode(t);
                            r.isChildOfGroup && (m.getNodeElement(r._groupParentNodeId).style.opacity = 1), (e.style.opacity = 1);
                        }
                    },
                    s = function (t) {
                        if (v) {
                            var e = OrgChart._getClientXY(t),
                                ...
                                a = { left: m.width() - (i.x + m.config.padding) < 0, right: i.x - m.config.padding < 0, down: m.height() - (i.y + m.config.padding) < 0, up: i.y - m.config.padding < 0 };
                            if (a.left || a.right || a.up || a.down) {
                                O.classList.remove("cursor-grab"), O.classList.add("cursor-move");
                                var o = x[4],
                                    n = x[5],
                                    l = v.x,
                                    s = v.y,
                                ...
                                if ((m.stopMove(), O.classList.add("cursor-grab"), O.classList.remove("cursor-move"), k(u, C), (C = u = null), m.config.enableDragDrop))
                                    for (; null != r && r != O; ) {
                                ...
                                if (null != u) {
                                    var g = m.getBGNode(u);
                                    g.isChildOfGroup && (m.getNodeElement(g._groupParentNodeId).style.opacity = 0.8), (C.style.opacity = 0.5);
                                }
                                var p = (e.x - v.x) / w,
                                    f = (e.y - v.y) / w;
                                (x[4] = y + p), (x[5] = b + f), _.setAttribute("transform", "matrix(" + x.toString() + ")");
                            }
                        }
                    },
                    h = function (t) {
                        if (
                            ...
                            return k(u, C), O.removeChild(_), void (m._gragStartedId = null);
                        var e = m.getBGNode(u);
                        if (e.isChildOfGroup && l.isChildOfGroup && e._groupParentNodeId == l._groupParentNodeId) return k(u, C), O.removeChild(_), void (m._gragStartedId = null);
                        if (!1 === OrgChart.events.publish("drop", [m, l.id, e.id])) return k(u, C), O.removeChild(_), void (m._gragStartedId = null);
                        if (null == m.config.dragDropMenu || (l.isGroup && !e.isGroup)) m._canUpdateLink(l.id, u) ? m.linkNode(l.id, u) : (O.removeChild(_), k(u, C));
                        ...
                        } else O.removeChild(_), k(u, C);
                        m._gragStartedId = null;
                    };
                O.addEventListener(n.move, s), O.addEventListener(n.up, h), n.leave && O.addEventListener(n.leave, h);
            }
        }
    }),
    ...
    (OrgChart.prototype._nodeClickHandler = function (t, e) {
        if (!1 === OrgChart.events.publish("click", [this, { node: this.getBGNode(t), event: e }])) return !1;
        ...
        if (t) {
            if (((this._movePosition = t), !this._moveInterval)) {
                ...
                this._moveInterval = setInterval(function () {
                    ...
                    r._movePosition.left && (o++, (t.x = (o * OrgChart.MOVE_STEP) / a), (t.xWithoutScale = o * OrgChart.MOVE_STEP)),
                        r._movePosition.right && (o++, (t.x = (-o * OrgChart.MOVE_STEP) / a), (t.xWithoutScale = -o * OrgChart.MOVE_STEP)),
                        r._movePosition.up && (n++, (t.y = (-n * OrgChart.MOVE_STEP) / a), (t.yWithoutScale = -n * OrgChart.MOVE_STEP)),
                        r._movePosition.down && (n++, (t.y = (n * OrgChart.MOVE_STEP) / a), (t.yWithoutScale = n * OrgChart.MOVE_STEP)),
    ...
    (OrgChart.prototype._mouseDownHandler = function (t, e, r) {
        ...
        if ("pan" == c.type) {
            ...
            (o.style.display = "inherit"),
                ...
                OrgChart.anim(o, { transform: [0, 0, 0, 0, l, g], opacity: 0 }, { transform: [1 / d, 0, 0, 1 / d, l, g], opacity: 1 }, 300, OrgChart.anim.outBack);
        }
        var p = function (t) {
    ...
    (OrgChart.searchUI.createSearchIcon = function (t) {
        return (
            '<div data-id="search-icon" style="display:none;padding:5px; position:absolute;top:' + t + "px;left:" + t + 'px;border:1px solid transparent;"><div><div style="float:left;">' + OrgChart.icon.search(32, 32) + "</div></div></div>"
        );
    }),
    void 0 === OrgChart && (OrgChart = {}),
    ...
    (OrgChart.server.prototype._read = function (a, t) {
        ...
        null == e && (e = OrgChart.local),
            e._walk(s, this.config, function (t) {
                ...
                a({ minX: e.minX, minY: e.minY, maxX: e.maxX, maxY: e.maxY, nodes: l, roots: s, groupChildren: n.groupChildren, limit: t });
            });
    }),
    (OrgChart.server.prototype.find = function (t) {
            ...
            for (var d in h) {
                ...
                (0 < this.config.searchFields.length && -1 == this.config.searchFields.indexOf(d)) ||
                    (c &&
                        ...
                        n.push({ id: h.id, propertyName: d, isId: d == OrgChart.ID, isNodeParam: o(d), weight: OrgChart.accentFold(c).indexOf(t), data: h }));
            }
        }
        n.sort(function (t, e) {
        ...
        for (s = 0; s < n.length && s != OrgChart.SEARCH_RESULT_LIMIT; s++) {
            ...
            if (!g) {
                ...
                l.push({ id: n[s].id, node: new OrgChart.node(n[s], null, [], v), textId: u, textInNode: f, text: C, img: m });
            }
        }
        return l;
    }),
    ...
    (OrgChart.server._createNodes = function (a, t, e, r) {
        ...
        for (c = 0; c < n.length; c++) {
            ...
            t == OrgChart.action.exporting && null != e.id && (l = [o[e.id]]),
                x ? ((v.state = x.state), v.state == OrgChart.COLLAPSE && m.push(v.id), OrgChart.server._setNodeGroupState(v, x.groupState, a.orientation)) : OrgChart.server._setNodeGroupState(v, OrgChart.EXPAND, a.orientation),
                ...
                if (y) {
                    if (y.parent)
                        for (var b = (H = y.parent).children.length - 1; 0 <= b; b--) {
                            (U = H.children[b]) == y && ((U.parent = null), H.children.splice(b, 1), H.childrenIds.splice(b, 1));
                        }
        ...
        for (c = 0; c < s.length; c++) {
            ...
            if (H) {
                ...
                ((o[_.id] = _).isAssistant = !0), (x = r[_.id]) && ((o[_.id].state = x.state), o[_.id].state == OrgChart.COLLAPSE && m.push(_.id)), OrgChart.server._initStates(_, o, t, a, e, m);
                var k = [];
                for (b = H.children.length - 1; 0 <= b; b--) {
                    (U = H.children[b]).isAssistant
                        ? ((U.parent = null), H.children.splice(b, 1), H.childrenIds.splice(b, 1), k.splice(0, 0, U.id))
                        : ((U.pid = _.id), (U.parent = _).children.unshift(U), _.childrenIds.unshift(U.id), H.children.splice(b, 1));
                }
                if (k.length % 2) {
                    var S = o[k[k.length - 1]],
                        I = [S.w, S.h],
                        A = "transperant_" + S.templateName;
                    (OrgChart.templates[A] = { linkAdjuster: {}, link: "", node: "", nodeMenuButton: "", size: I }),
                        ((W = new OrgChart.node(H.id + "_transperant", S.pid, [], A)).isAssistant = !0),
                        (x = r[(o[W.id] = W).id]) && ((o[W.id].state = x.state), o[W.id].state == OrgChart.COLLAPSE && -1 == m.indexOf(W.id) && m.push(W.id)),
                        k.splice(k.length - 1, 0, W.id),
                        OrgChart.server._initStates(W, o, t, a, e, m);
                }
                var N = 1;
                ...
                for (b = 0; b < k.length; b += 3) {
                    ...
                    for (var T = E; "split" == T.templateName && (T = T.parent); ) T.childrenIds.push(M.id), T.childrenIds.push(L.id), T.childrenIds.push(B.id);
                    (x = r[L.id]) && ((o[L.id].state = x.state), o[L.id].state == OrgChart.COLLAPSE && -1 == m.indexOf(L.id) && m.push(L.id)), OrgChart.server._initStates(L, o, t, a, e, m);
                }
            }
        }
            ...
            for (var H = OrgChart.server._getRealParent(P), F = P.id; null != H; ) {
                if ((-1 != (D = m.indexOf(H.id)) && m.splice(D, 1), (H.state = OrgChart.EXPAND), e.options.parentState === OrgChart.COLLAPSE_PARENT_NEIGHBORS))
                    for (c = 0; c < H.childrenIds.length; c++) {
                        ...
                        if (!OrgChart.server._isSplit(U) && !U.isAssistant && U.id != F) -1 == (D = m.indexOf(H.childrenIds[c])) && m.push(H.childrenIds[c]), (U.state = OrgChart.COLLAPSE);
                    }
                ...
                (F = H.id), (H = OrgChart.server._getRealParent(H));
            }
            if (e.options.childrenState === OrgChart.COLLAPSE_SUB_CHILDRENS)
                for (c = 0; c < P.childrenIds.length; c++) {
                    if ((-1 != (D = m.indexOf(P.childrenIds[c])) && m.splice(D, 1), ((U = o[P.childrenIds[c]]).state = OrgChart.EXPAND), !U.isAssistant && !OrgChart.server._isSplit(U)))
                        for (b = 0; b < U.childrenIds.length; b++) {
                            var D,
                                G = o[U.childrenIds[b]];
                            -1 == (D = m.indexOf(U.childrenIds[b])) && m.push(U.childrenIds[b]), (G.state = OrgChart.COLLAPSE);
                        }
                }
        }
        ...
        for (c = 0; c < m.length; c++) {
            if ((H = (v = o[m[c]]).parent))
                for (b = H.children.length - 1; 0 <= b; b--) {
                    if (H.children[b] == v)
                        if ((-1 == H.collapsedChildrenIds.indexOf(v.id) && H.collapsedChildrenIds.push(v.id), H.children.splice(b, 1), "split" == H.templateName)) {
                            if ((E = v.parent)) {
                                for (; "split" == E.templateName; ) E = E.parent;
                                for (var R = E.childrenIds.length - 1; 0 <= R; R--) {
                    ...
                    if ((H = v.parent)) {
                        ...
                        for (b = H.children.length - 1; 0 <= b; b--) {
                            if ((U = H.children[b]) != v && 0 == U.childrenIds.length && !U.isAssistant && "split" != U.templateName) {
                                (U.parent = v), (U.pid = v.id), (U.layout = OrgChart.mixed), H.children.splice(b, 1);
                                var Y = v.children.length;
                                (v.children[Y] = U), (v.layout = OrgChart.mixed);
                            }
                        }
                    }
            }
            ...
            for (c = 0; c < q.length; c++) {
                ...
                for (b = H.children.length - 1; 0 <= b; b--) {
                    if (OrgChart.server._mixedLayoutAllNodes(H))
                        if (0 == (U = H.children[b]).childrenIds.length && !U.isAssistant && "split" != U.templateName && ((U.parent && "split" != U.parent.templateName) || U.parent.isAssistant)) {
                            if (
                                (((U = H.children[b]).parent = null),
                                (U.layout = OrgChart.tree),
                                H.children.splice(b, 1),
                                H.childrenIds.splice(b, 1),
                                a.layout == OrgChart.treeRightOffset && V.splice(0, 0, U.id),
                                a.layout == OrgChart.treeLeftOffset || a.layout == OrgChart.treeRightOffset)
                            ) {
                                var W;
                                A = "transperant_" + U.templateName;
                                (OrgChart.templates[A] = { linkAdjuster: {}, link: "", node: "", nodeMenuButton: "", size: [0, 0] }),
                                    ((W = new OrgChart.node(U.id + "_transperant", null, [], A)).layout = OrgChart.tree),
                                    (o[W.id] = W),
                                    V.splice(0, 0, W.id);
                            }
                            a.layout != OrgChart.treeRightOffset && V.splice(0, 0, U.id);
                ...
                for (b = 0; b < V.length; b += 3) {
                    ...
                    0 != b && (E = o[V[b - 3]]),
                        ...
                        L && (0 != b && (E = o[V[b - 2]]), (L.parent = E), (L.pid = E.id), E.children.push(L), H.childrenIds.push(L.id)),
                        B && (0 != b && (E = o[V[b - 1]]), (B.parent = E), (B.pid = E.id), E.children.push(B), H.childrenIds.push(B.id));
                }
            }
        }
    ...
    (OrgChart.server._getResponse = function (t, e, r, i, a, o, n, l, s, h, d, c, g, p, f) {
        ...
        if (((C.top = l - i.padding), (C.left = n - i.padding), (C.bottom = o + i.padding - e / x), (C.right = a + i.padding - t / x), (C.maxX = a), (C.minX = n), (C.maxY = o), (C.minY = l), null == s && i.align == OrgChart.CENTER)) {
            ...
            if (y - 2 * i.padding >= a - n)
                switch (((w = (a + n) / 2 - y / 2), i.orientation)) {
                    case OrgChart.orientation.right:
                    case OrgChart.orientation.right_top:
                        w = (n - a) / 2 - y / 2;
                }
            ...
            if (b - 2 * i.padding >= o - l)
                ...
                switch (((_ = -(b / 2 - (o - l) / 2)) > -i.padding && (_ = -i.padding), i.orientation)) {
                    case OrgChart.orientation.bottom:
                    case OrgChart.orientation.bottom_left:
        ...
        for (var I in g) {
            ...
            if (OrgChart.server._isVisible(A, i, s, d)) {
                ...
                if (d == OrgChart.action.expandCollapse && f && f[A.id] && "expandCollapseToLevel" == c.method) {
                    if (((N = { x: (T = f[A.id]).x, y: T.y }), T)) {
                        N = { x: T.x, y: T.y };
                        for (var E = A, M = null; null != E; ) f[E.id] && f[E.id].state == OrgChart.COLLAPSE && (M = E), (E = E.parent);
                        M && M.parent && (N = { x: M.parent.x, y: M.parent.y });
                    }
                    if ((L = g[c.id])) {
                        for (E = A.parent; null != E; ) E = E.parent;
                        E && (N = { x: L.x + L.w / 2 - A.w / 2, y: L.y + L.h / 2 - A.h / 2 });
                    }
                } else if (d == OrgChart.action.expandCollapse && f && f[A.id]) {
                    var L;
                    if (((N = { x: (T = f[A.id]).x, y: T.y }), "all" == c.ids && T)) {
                        N = { x: T.x, y: T.y };
                        for (E = A, M = null; null != E; ) f[E.id] && f[E.id].state == OrgChart.COLLAPSE && (M = E), (E = E.parent);
                        M && M.parent && (N = { x: M.parent.x, y: M.parent.y });
                    }
                    if ((L = g[c.id])) {
                    ...
                    var B;
                    if ((null != (T = f[A.id]).x && null != T.y && (N = { x: T.x, y: T.y }), (B = g[c.id]) && B == A)) (E = A.parent) && E.id == c.id && (N = { x: B.x + B.w / 2 - A.w / 2, y: B.y + B.h / 2 - A.h / 2 });
                } else if (d == OrgChart.action.groupMaxMin && f && f[A.id]) {
                    N = { x: (T = f[A.id]).x, y: T.y };
                } else if (d == OrgChart.action.insert && c && c.insertedNodeId == A.id) N = { x: A.parent.x, y: A.parent.y };
                else if ((d == OrgChart.action.update || d == OrgChart.action.insert) && f && f[A.id]) {
                    var T;
                    N = { x: (T = f[A.id]).x, y: T.y };
                } else d !== OrgChart.action.exporting && r && !r[A.id] && (m[0].push(A.id), m[1].push({ opacity: 0 }), m[2].push({ opacity: 1 }));
                null != N && null != N.x && null != N.y && ((N.x == A.x && N.y == A.y) || (m[0].push(A.id), m[1].push({ transform: [1, 0, 0, 1, N.x, N.y] }), m[2].push({ transform: [1, 0, 0, 1, A.x, A.y] })));
            }
        }
        return { animations: m, boundary: C, viewBox: s, visibleNodes: u, nodes: g, allFields: OrgChart.server.getAllFields(i) };
    }),
    ...
    (OrgChart.ui = {
        ...
        node: function (t, e, r, i, a, o, n, l, s, h) {
            ...
            if ((d.defs && (c = c.replace("{randId}", OrgChart.ui._defsIds[t.templateName])), null == n && (n = i.nodeBinding), t.isGroup)) {
                ...
                for (var f in n) {
                    ...
                    if (e) {
                        var C = e[u];
                        if (("function" == typeof u && (C = u(h, t)), null != C && null != C && null != d[f]))
                            c += (OrgChart._lblIsImg(i, f) || "string" != typeof C || (C = OrgChart.wrapText(C, d[f])), d[f].replace("{val}", C)).replaceAll("{randId}", OrgChart._randomId()).replaceAll("{randId2}", OrgChart._randomId());
                    }
                }
            ...
            return (
                t.isGroup &&
                    ...
                    (t.groupState == OrgChart.EXPAND ? (c += OrgChart.MINIMIZE.replace("{x}", t.w - 45).replace("{id}", t.id)) : (c += OrgChart.MAXIMIZE.replace("{x}", t.w - 45).replace("{id}", t.id))),
        ...
        expandCollapse: function (t, e, r, i, a) {
            ...
            switch (r.orientation) {
                ...
                case OrgChart.orientation.left:
                case OrgChart.orientation.left_top:
                    (n = e.x + e.w), (l = e.y + e.h / 2);
            }
            if (
                ((n -= s.expandCollapseSize / 2),
                (l -= s.expandCollapseSize / 2),
                e.collapsedChildrenIds.length
                    ? ((o += OrgChart.expcollOpenTag.replace("{id}", e.id).replace("{x}", n).replace("{y}", l)), (o += s.plus))
                    : ((o += OrgChart.expcollOpenTag.replace("{id}", e.id).replace("{x}", n).replace("{y}", l)), (o += s.minus)),
        ...
        link: function (t, e, r, i) {
            ...
            for (var l = 0; l < t.children.length; l++) {
                var s = t.children[l],
                    h = { xa: 0, ya: 0, xb: 0, yb: 0, xc: 0, yc: 0, xd: 0, yd: 0, x: 0, y: 0, rotate: 0 },
        ...
        _linkBottomToTop: function (t, e, r, i) {
            ...
            return (
                ...
                (h = e.y + e.h + r.linkAdjuster.fromY),
                {
                    ...
                    xb: n,
                    yb: (c =
                        t.rightNeighbor && t.rightNeighbor.isAssistant && "split" == e.templateName ? t.rightNeighbor.y - i : "split" != t.templateName || (!e.isAssistant && 2 != e.layout) ? ("split" == e.templateName ? o - i : h + i) : h),
                    xc: (d = l),
                    yc: c,
                    xd: s,
                    yd: h,
    ...
    (OrgChart._menuPosition = function (t, e, r) {
        var i = t.getBoundingClientRect(),
            ...
            n = i.left - a.left,
            l = i.top - a.top;
        return i.top + o.height > a.top + a.height && (l -= o.height), i.left - o.width < a.left && (n += o.width), { x: n, y: l };
    }),
    ...
    (OrgChart.childrenCount = function (t, e, r) {
        var i = e.childrenIds;
        null == r && ((r = []), (i = e.childrenIds));
        for (var a = 0; a < i.length; a++) {
            var o = i[a];
            "string" == typeof o && -1 == o.indexOf("split") && -1 == o.indexOf("transperant") ? -1 == r.indexOf(o) && r.push(o) : "string" != typeof o && -1 == r.indexOf(o) && r.push(o), OrgChart.collapsedChildrenCount(t, t.nodes[o], r);
        }
        return r.length;
    }),
    (OrgChart.collapsedChildrenCount = function (t, e, r) {
        var i = e.childrenIds;
        null == r && ((r = []), (i = e.collapsedChildrenIds));
        for (var a = 0; a < i.length; a++) {
            var o = i[a];
            "string" == typeof o && -1 == o.indexOf("split") && -1 == o.indexOf("transperant") ? -1 == r.indexOf(o) && r.push(o) : "string" != typeof o && -1 == r.indexOf(o) && r.push(o), OrgChart.collapsedChildrenCount(t, t.nodes[o], r);
        }
    ...
    (OrgChart.pdfPrevUI._handler = function (t, e, r) {
        ...
        for (var s = l.querySelector("svg"), h = t.element.querySelector("#bg-ppdf-content"), d = 0; d < a.length; d++) {
            ...
            a[d].footer && (f = a[d].footer),
                ...
                a[d].html
                    ? g.write(OrgChart._exportHtml(a[d].html, i, a[d].innerSize.w, a[d].innerSize.h, p, f))
                    : (s.setAttribute("viewBox", a[d].vb), g.write(OrgChart._exportHtml(l.innerHTML, i, a[d].innerSize.w, a[d].innerSize.h, p, f)));
        ...
        for (var r, i, a, o, n, l = "", s = 0; s < this.config.clinks.length; s++) {
            ...
            if (
                ...
                switch (this.config.orientation) {
                    case OrgChart.orientation.top:
                    case OrgChart.orientation.top_left:
                        x <= y ? ((_ = 1), (O.x = x + d.w / 10), (v.x = y - c.w / 10)) : ((_ = -1), (O.x = x - d.w / 10), (v.x = y + c.w / 10)),
                            p == u ? ((_ = 1), (O.y = p), (v.y = u)) : u < p ? ((O.y = p), (v.y = u + c.h)) : ((O.y = p + d.h), (v.y = u));
                        break;
                    case OrgChart.orientation.bottom:
                    case OrgChart.orientation.bottom_left:
                ...
                l +=
                    ...
                    m.link
                        ...
                        .replaceAll("{c.x}", k.x)
                        .replaceAll("{c.y}", k.y);
                var I = ((r = O), (a = k), void 0, (o = ((i = v).x - r.x) / 2 + r.x), (n = (i.y - r.y) / 2 + r.y), { x: (o - a.x) / 2 + a.x, y: (n - a.y) / 2 + a.y });
                h.label && (l += m.label.replace("{x}", I.x).replace("{y}", I.y).replace("{val}", h.label)), (l += OrgChart.grCloseTag);
            }
            function A(t, e, r) {
                null == r && (r = 1);
                var i = e.x - t.x,
                ...
                return (o = (o / (Math.sqrt(i * i + a * a) * r)) * OrgChart.CLINK_CURVE), { x: t.x + i / 2 - a * o, y: t.y + a / 2 + i * o };
            }
        }
        e.content += l;
    }),
    ...
    (OrgChart.prototype._slinks = function (_, k) {
        ...
        function t(t, e, r) {
            ...
            var s = { p: t.x + t.w / 2 + n.expandCollapseSize, q: t.y, r: t.x + t.w / 2 + n.expandCollapseSize, s: A.minY + l };
            if (t.level == e.level)
                switch (((a = e), _.config.orientation)) {
                    case OrgChart.orientation.top:
                    case OrgChart.orientation.top_left:
                        i.push([s.p, s.q]), i.push([s.p, s.q - l / 3]), (n = OrgChart.t(a.templateName, I)), i.push([a.x + a.w / 2 + n.expandCollapseSize, i[i.length - 1][1]]), i.push([i[i.length - 1][0], a.y]);
                        break;
                    case OrgChart.orientation.bottom:
                    case OrgChart.orientation.bottom_left:
                        (s.q = t.y + t.h),
                ...
                switch (_.config.orientation) {
                    ...
                    case OrgChart.orientation.bottom:
                    case OrgChart.orientation.bottom_left:
                        (s.q = t.y + t.h), (s.s = A.maxY - l), i.push([s.p, s.q]), i.push([s.r, t.y + t.h + l / 3]);
                        break;
                    case OrgChart.orientation.left:
                    case OrgChart.orientation.left_top:
                        (s.p = t.x), (s.q = t.y + t.h / 2 + n.expandCollapseSize), (s.r = A.minX - l), (s.s = t.y + t.h / 2 + n.expandCollapseSize), i.push([s.p, s.q]), i.push([t.x - l / 3, s.q]);
                        break;
                    case OrgChart.orientation.right:
                    case OrgChart.orientation.right_top:
                        (s.p = t.x + t.w), (s.q = t.y + t.h / 2 + n.expandCollapseSize), (s.r = A.maxX + l), (s.s = t.y + t.h / 2 + n.expandCollapseSize), i.push([s.p, s.q]), i.push([t.x + t.w + l / 3, s.q]);
                }
                for (var h = t; null == a; ) {
                    var d = !1,
                        c = h.parent,
                    ...
                    if (!d) {
                        var f = i[i.length - 1][0],
                            u = 0;
                        if (c.parent)
                            switch (((l = _.config.levelSeparation), (c.parent.layout != OrgChart.mixed && c.parent.layout != OrgChart.tree) || (l = _.config.mixedHierarchyNodesSeparation), _.config.orientation)) {
                                case OrgChart.orientation.top:
                                case OrgChart.orientation.top_left:
                ...
                switch (((n = OrgChart.t(a.templateName, I)), i.splice(i.length - 1, 1), _.config.orientation)) {
                    case OrgChart.orientation.top:
                    case OrgChart.orientation.top_left:
            ...
            var x = i.join(" ");
            if (((S += '<g c-link-from="{from}" c-link-to="{to}">'.replace("{from}", t.id).replace("{to}", e.id) + n.link.replaceAll("{d}", x)), N.label)) {
            ...
            (S += OrgChart.grCloseTag), (k.content += S);
        }

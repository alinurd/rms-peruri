...
$(document).on("click", ".del_mitigasi", function () {
	...
	$(document).on("click", ".add-kri", function () {
		...
		row.append('<tr><td style="padding-left:0px;">' + riskEvent + riskEvent_no + '</td><td class="text-center"><i class="fa fa-search browse-kri text-primary pointer"></i> | <i class="fa fa-trash text-warning pointer" title="menghapus data" id="sip"></i></td></tr>');
	})
	...
	$(document).on("click", ".browse-couse, .browse-impact, .browse-event, .browse-kri", function () {
...
console.log(data);
	...
	// });
	$(document).on("change", "#residual_impactx, #residual_likelihoodx", function () {
...
// console.log('jalan')
	...
	$(document).on("click", "#add_cause_news", function () {
		...
		if (theTable.rows[rl].cells[1].childNodes[0].value == "0") {
			...
			td2.innerHTML = '<select name="risk_couse_no[]" class="select2 form-control" style="width:100%;" id="risk_couseno' + rl + '">' 
				'</select>';
				td3.innerHTML = '<span nilai="0" style="cursor:pointer;" onclick="remove_install_cause(this,0)"><i class="fa fa-cut" title="menghapus data" id="sip"></i></span>';
...
// console.log(rl)
	...
	$(document).on("click", "#add_impact_news", function () {
		...
		if (theTable.rows[rl].cells[1].childNodes[0].value == "0") {
			...
			td2.innerHTML = '<select name="risk_impact_no[]" class="select2 form-control" style="width:100%;" id="impactno' + rl + '">' 
				'</select>';
				td3.innerHTML = '<span nilai="0" style="cursor:pointer;" onclick="remove_install_cause(this,0)"><i class="fa fa-cut" title="menghapus data" id="sip"></i></span>';
...
function show_revisi(hasil) {
	$("#modal_general").find(".modal-body").html(hasil.register);
	$("#modal_general").find(".modal-title").html('Risk Context yang Harus di Perbaiki');
	$("#modal_general").modal("show");
}

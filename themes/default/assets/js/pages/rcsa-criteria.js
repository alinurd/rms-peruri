...
$(document).ready(function () {
  //   $("#tab-00").addClass("hide");
  //   $("#tab-01").addClass("hide");
  //   $("#tab-02").addClass("hide");
  //   $("#tab-03").addClass("hide");
  //   $("#tab-04").addClass("hide");
...
$(function () {
  ...
  $("#add_sasaran_new").click(function () {
    ...
    row.append(
      '<tr><td class="text-center">' +
        ...
        "</td><td>" +
        limit +
        '</td><td class="text-center"><span class="text-primary" nilai="0" style="cursor:pointer;" onclick="remove_installx(this,0)"><i class="fa fa-cut"></span></td></tr>'
    );
  });
  ...
  $(document).on(
    "click",
    ".browse-couse, .browse-impact, .browse-event",
    function () {

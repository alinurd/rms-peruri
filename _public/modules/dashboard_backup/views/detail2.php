...
<!-- 			Level Akibat = <strong><span id="couse">-</span></strong>, Level Probabilitas = <strong><span id="impact">-</span></strong> -->
		...
		<tbody>
			...
			<tr class="pointer sub_detail" title="klik untuk melihat detail" data-id="<?=$row['id'];?>">
				...
				<td style="text-align: center; background-color:<?=$row['warna'];?>;color:<?=$row['warna_text'];?>;"><?=$row['inherent_analisis'];?></td>
				<td style="text-align: center; background-color:<?=$row['warna_residual'];?>;color:<?=$row['warna_text_residual'];?>;"><?=$row['residual_analisis'];?></td>
			</tr>
			<?php endforeach;?>
       ...
       <?php
       $a = $data['baba'][$row1['rcsa_detail_no']]['inherent_analisis'];
       $b = $data['baba'][$row1['rcsa_detail_no']]['warna'];
       $c = $data['baba'][$row1['rcsa_detail_no']]['warna_text'];
       ?>
       <td style="background-color:<?=$b;?>;color:<?=$c;?>;"><?=$a;?></td>
                <td style=" text-align: center;background-color:<?=$row1['warna_action'];?>;color:<?=$row1['warna_text_action'];?>;"><?=$row1['inherent_analisis_action'];?></td>

			...
			<div class="x_content" style="overflow-x: auto;">
				<div class="col-md-6 col-sm-6 col-xs-6">
					<table class="table">
						...
						<tr><td><em><?=lang('msg_field_start_date');?></em><br/><div class="ml10 text-danger"><?=$parent['start_date'];?></div></td></tr>
				...
				<div class="col-md-6 col-sm-6 col-xs-6">
					<table class="table">
						...
						<tr><td><em>Progress Mitigasi</em><br/><div class="ml10 text-danger"><?=$parent['start_date'];?></div></td></tr>
						<tr><td><em>Tingkat Resiko</em><br/><div class="ml10 text-danger"><?=$parent['periode_name'];?></div></td></tr>
					</table>
				</div>
			</div>
		</section>

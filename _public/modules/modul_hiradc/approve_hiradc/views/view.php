...
<section id="main-content">
	<?php  echo form_open_multipart(base_url(_MODULE_NAME_.'/save_notes'),array('id'=>'form_input'));?>
	...
	<!--state overview start-->
		...
		<div class="row">
			<div class="col-md-12">
				...
				<a class="danger btn btn-default btn-flat" data-content="Kembali Ke Daftar" data-toggle="popover" href="<?php echo base_url(_MODULE_NAME_);?>" data-original-title="" title="">

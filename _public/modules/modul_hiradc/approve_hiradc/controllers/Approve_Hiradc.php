...
class Approve_Hiradc extends BackendController {
	var $tmp_data=array();
	...
	public function __construct()
	{
		...
		$this->set_Open_Tab('Konteks Risiko');
			...
			$this->addField(array('field'=>'owner_no', 'size'=>100));
			...
			$this->addField(array('field'=>'sts_approve', 'input'=>'boolean', 'size'=>15));
		$this->set_Close_Tab();
	...
	function save_notes(){
		...
		header('location:'.base_url('approve'));
	}
	...
	function list_MANIPULATE_PERSONAL_ACTION($tombol, $rows){
		...
		$url=base_url($this->modul_name.'/action-detail');
		$tombol['print']=array();
		$tombol['view']=array();
		$tombol['delete']=array();

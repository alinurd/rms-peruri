...
<div class="panel-body margin-bottom-15">
	<div class="tab-content">
		<div id="home" class="tab-pane <?php echo $active_tab[0];?>">
			<?php  echo form_open_multipart(base_url('rcsa/save_detail'),array('id'=>'form_input'));?>
			...
			<div id="content_detail">
								...
								<?php 
									if (count($data['event_no'])>0){
										foreach($data['event_no'] as $row){
											echo form_textarea("risk_event", $row['code'].' - '.$row['name']," class='form-control text-left' readonly='' rows='2' cols='5' style='overflow: hidden; width: 80% !important; height: 75px;' id='risk_event' ")."&nbsp;&nbsp;&nbsp;";
											?>
											...
											?>
												<tr>
													<td class="no-padding-left no-border padding-5 " width="82%">
														...
														?>
															<div id="attr_awal">
																<a href="<?php echo base_url('rcsa/get_file/'.$row['name']);?>"><?php echo $ext.' '.$row['real_name'];?></a>
				...
				<div class="row well">
					...
					<div class="col-md-4 pull-right">
						<button class="btn btn-danger btn-flat pull-right" data-content="Add Library" data-toggle="popover" name="l_add_library" id="l_add_library" value="Add Library " type="button">
...
<script>
	...
	function get_data(nil, tblx, count){
		var url='<?php echo base_url("rcsa/get-data-source");?>';
	...
	$('.nav-tabs > li > a').bind('click', function (e) {
		var url='<?php echo base_url("rcsa/change_tab");?>';

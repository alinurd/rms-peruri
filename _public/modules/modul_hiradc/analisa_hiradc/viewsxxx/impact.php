<br/>
<strong> IMPACT LINK </strong>
<table class="table" id="instlmt_impacy_x">
	<thead>
		<tr>
	...
	<tbody>
<?php
	$cbo = form_dropdown('library_no[]', $cbogroup_impact,'','class="form-control select3"');
...
<center>
	<button id="add_event_impact" class="btn btn-primary" type="button" value="<?=lang('msg_field_tambah_data');?>" name="add_event_impact" syle="margin-bottom:20px;"> <i class="fa fa-plus"></i> </button>
	<hr>
</center>

<script type="text/javascript">
	
	$("#add_event_impact").click(function(){
		var cbo='<?php echo addslashes(preg_replace("/(\r\n)|(\n)/mi","",$cbo));?>';
		var edit='<?php echo addslashes(preg_replace("/(\r\n)|(\n)/mi","",$edit));?>';
		$(this).addClass('disabled');
		var theTable= document.getElementById("instlmt_impacy_x");
		
		var rl = $('table#instlmt_impacy_x tr:last').index() + 1;
		...
		$("#add_event_impact").removeClass('disabled');
	})

...
echo form_open_multipart(base_url('rcsa/save_level'),array('name'=>'form_level','id'=>'form_input_level','class'=>'form-inline'));?>
...
<div id="content_detail">
	<table class="table table-condensed no-margin-bottom" width="100%" cellspacing="0" cellpadding="0" border="0">
		<tbody>
			<tr>
				<td class="row-title no-border latar-risk" style="color:#fff;">
			...
			<tr>
				...
				<td class="no-border vcenter text-right">
					<hr class="no-padding no-margin" style="margin-bottom:20px;">
						<?php echo lang('msg_field_likelihood');?> : <?php echo form_dropdown('inherent_likelihood',$cbo_level_like, (empty($data['inherent_likelihood']))?'':$data['inherent_likelihood']	,'class="form-control" id="inherent_likelihood"');?>
						<span style="margin-left:40px;"><?php echo lang('msg_field_impact');?> : </span><?php echo form_dropdown('inherent_impact',$cbo_level_impact_baru, (empty($data['inherent_impact']))?'':$data['inherent_impact'],'class="form-control" id="inherent_impact"');?>
			...
			<tr>
				...
				<td class="no-border">
					<?php echo form_dropdown('treatment_no',$cbo_treatment, (empty($data['treatment_no']))?'':$data['treatment_no']	,'class="form-control" id="treatment_no"');?>
				</td>
			</tr>
		</tbody>
	</table>
	...
	<div class="box-body">
		...
		<span class="delete btn btn-warning btn-flat" data-content="Remove Data Event Detail" data-toggle="popover" url="<?php echo base_url('rcsa/delete-event/'.$id_rcsa.'/'.$id_event_detail);?>">
...
<script>
	...
	$("#nilai_dampak").change(function(){
		var url='<?php echo base_url("rcsa/get_inherent_risk_level");?>';

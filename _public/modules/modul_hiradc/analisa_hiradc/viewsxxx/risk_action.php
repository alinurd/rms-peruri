						...
						<tbody>
							...
							foreach($data_risk_action as $row){ 
								...
								<tr>
									...
									<td style="text-align:center;width:10%;cursor:pointer;"><i class="fa fa-pencil edit_action" title="Edit data Action" value="<?php echo $row['id'];?>"></i> | <i url="<?php echo base_url('rcsa/delete-action/'.$id_rcsa.'/'.$id_event_detail.'/'.$row['id']);?>" class="fa fa-cut" title="Delete data" id="delete_list_action"></i></td>
								</tr>
								<?php 
							}
							?>

		...
		<div class="panel-body">
			<div class="row">
				<div class="col-md-6">
					...
					<?=form_dropdown('cboModul', $cbo_modul, $nm_modul,"id='cboModul' class='form-control select2' style='width:100% !important;' ");?>					
				</div>
				<div class="col-md-6">
					<strong><?=lang('msg_field_active_language');?></strong><br/>
					<?=form_dropdown('cboBahasa', $cbo_bahasa, $bahasa,"id='cboBahasa' class='form-control select2' style='width:100% !important;' ");?>					
				</div>
			</div>
		</div>
	</section>
				...
				<div class="col-md-12" id="content_bahasa">
					<section class="panel" id='isi_event_detail' style="border:1px solid #2A3542;">
						...
						<center style="margin-top:15px;">
							<button type="submit" value="Save" class="btn btn-primary"> S a v e </button>
						</center>
					</section>
				</div>
			</div>

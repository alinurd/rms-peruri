                        ...
                        <?php if (count($countDetail) === 0) : ?>
                            ...
                            <?php if ($pKey === 0) : ?>
                                <td width="5%" rowspan="<?= count($c['parent']) ?>">
                                    <select class="form-control" id="skala-<?= $pk['urut']; ?><?= $pk['id']; ?>" style="width: 110px;">
                                ...
                                <td width="5%" rowspan="<?= count($c['parent']) ?>">Perhitungan</td>
                            <?php endif; ?>
                        ...
                        <tr>
                            ...
                            <?php if ($dKey === 0) : ?>
                                <td width="5%" rowspan="<?= count($countDetail) ?>">
                                    <select class="form-control" id="skala-<?= $pk['urut']; ?><?= $d['id']; ?>" style="width: 110px;">
                                ...
                                <td width="5%" rowspan="<?= count($countDetail) ?>">Perhitungan</td>
                            <?php endif; ?>
                            <td class="text-center" width="10%">Hasil Penilaian</td>
                            <td width="5%">

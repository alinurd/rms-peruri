...
<table class="display table table-bordered" id="tbl_event">
    <thead>
        <tr>
            ...
            <th class="text-center" style="position: sticky; top: 0; background: #fff; z-index: 1;" width="10%">Target</th>
                            ...
                            <td rowspan="<?= count($c['parent']) ?>">
                                ...
                                <center>
                                     <!-- <table>
                                        ...
                                        <tr>
                                            --><input class="form-control perhitungan" style="width: 70px; text-align: center;" type="text" id="perhitungan-<?= $pk['urut']; ?><?= $pk['id']; ?>" name="perhitungan-<?= $pk['urut']; ?><?= $pk['id']; ?>" readonly> 
                                             <input class="form-control skor-perhitungan" style="width: 70px; text-align: center;" type="hidden" id="skor-perhitungan-<?= $pk['urut']; ?><?= $pk['id']; ?>" name="perhitungan-<?= $pk['urut']; ?><?= $pk['id']; ?>" readonly> 
                                         <!-- </tr>
                                    </table> -->
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <!-- <table>
                                        ...
                                        <tr>
                                            <td> --> <input class="form-control perhitungan" style="width: 100px; text-align: center" type="text" id="totalDetail-<?= $nc; ?>" name="totalDetail-<?= $nc; ?>" readonly>
                    </td>
                    <!--  <td> --> <input class="form-control skor-perhitungan" style="width: 100px; text-align: center" type="hidden" id="skor-totalDetail-<?= $nc; ?>" name="totalDetail-<?= $nc; ?>" readonly></td>
                    <!--  </tr>
                                    </table> -->

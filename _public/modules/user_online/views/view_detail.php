<?php echo form_open_multipart($this->uri->uri_string,array('id'=>'form_input_alert'));?>
<div class="row">
	<div class="col-sm-12">
			...
			<div class="box-body">
				<table class="table table-hover table-borderless" id="tbl_chart">
					...
					<tr class="<?=$sts_penyakit;?>">
						...
						<td><?=form_dropdown('cboStsRumor', $cbo_boolean, '', 'class="form-control cbo-full" id="cboStsRumor"');?></td>
					</tr>
					<tr>

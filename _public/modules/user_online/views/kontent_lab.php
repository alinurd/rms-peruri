						...
						<div class="row">
							<div class="col-sm-6">
								<div class="box box-warning box-solid height-400">
									...
									<div class="box-body">										
										<canvas id="bar-chart-alert-lab" width="800" height="380"></canvas>
									</div>
								</div>
							</div>
							...
							<div class="col-sm-6">
								<div class="box box-warning box-solid height-400">
									...
									<div class="box-body" id="content_map_lab">
										<?php echo $maps_lab['map_lab']['js']; ?>
										<?php echo $maps_lab['map_lab']['html'];?>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="box box-warning box-solid height-400">
									...
									<div class="box-body">
										<canvas id="bar-chart-lengkap-lab" width="800" height="380"></canvas>
									</div>
								</div>
							</div>
							...
							<div class="col-sm-6">
								<div class="box box-warning box-solid height-400">
									...
									<div class="box-body">
										<canvas id="bar-chart-tepat-lab" width="800" height="380"></canvas>
									</div>
								</div>
							</div>
						</div>

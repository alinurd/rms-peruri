            ...
            <div class="x_content" style="overflow-x: auto;">
				...
				<div class="col-md-6 col-sm-6 col-xs-12" style="background-color:#c0d5e5;">
					<table class="table">
						...
						'<span ><span style="background-color:<?=$detail['warna'];?>;color:<?=$detail['warna_text'];?>;">&nbsp;<?=$detail['inherent_analisis'];?>&nbsp;</span></span> &nbsp;&nbsp;&nbsp; => &nbsp;&nbsp;
						<span ><span style="background-color:<?=$detail['warna_residual'];?>;color:<?=$detail['warna_text_residual'];?>;">&nbsp;<?=$detail['residual_analisis'];?>&nbsp;</span></span></td></tr>
					</table>
            	</div>
            </div>
        </section>
...
<div class="hide" id="input_realisasi">

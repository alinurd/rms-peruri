<table class="table" id="tbl_sasaran_new">
	<thead>
		<tr>
			...
			<th rowspan="2" style="text-align:center;">Sasaran</th>
			<th rowspan="2" style="text-align:center;">Risk Appetite statement</th>
			<th colspan="3" style="text-align:center;">Threshold</th>
			<th rowspan="2" width="10%" style="text-align:center;">Aksi</th>
		</tr>
		<tr>
	...
	<tbody>
		...
		foreach ($field as $key => $row) {
			...
			if ($this->uri->segment(2) == "view") {
				...
				$appetite = '<input name="appetite[]" value="' . $row['appetite'] . '" type="text" disabled="disabled" onkeyup="checkInput(this.value)" id="appetite" class="form-control" style="overflow: hidden; width: 100%;">';
				$tolerance = '<input name="tolerance[]" value="' . $row['tolerance'] . '" type="text" disabled="disabled" onkeyup="checkInput(this.value)" id="tolerance" class="form-control" style="overflow: hidden; width: 100%;">';
				$limit = '<input name="limit[]" value="' . $row['limit'] . '" type="text" disabled="disabled" onkeyup="checkInput(this.value)" id="limit" class="form-control" style="overflow: hidden; width: 100%;">';
			} else {
				$edit = form_hidden('id_edit[]', $row['id']);
				$sasaran = form_textarea('sasaran[]', $row['sasaran'], "  maxlength='10000' class='form-control' disabled='disabled' rows='2' cols='5' style='overflow: hidden; height: 104px;'");
				$statement = form_textarea('statement[]', $row['statement'], "  maxlength='10000' class='form-control' disabled='disabled' rows='2' cols='5' style='overflow: hidden; height: 104px;'");
		...
		$appetite = '<input name="appetite[]"; type="text" onkeyup="checkInput(this.value)" id="appetite" class="form-control" style="overflow: hidden; width: 100%;">';
		$tolerance = '<input name="tolerance[]"; type="text" onkeyup="checkInput(this.value)" id="tolerance" class="form-control" style="overflow: hidden; width: 100%;">';
		$limit = '<input name="limit[]"; type="text" id="limit" onkeyup="checkInput(this.value)" class="form-control" style="overflow: hidden; width: 100%;">';

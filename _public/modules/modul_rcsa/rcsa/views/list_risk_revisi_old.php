...
<span class="btn btn-warning btn-flat">
    <a href="<?= base_url('rcsa/risk-event/' . $owner_no . '/' . $id); ?>" target="" style="color:#ffffff;" title=""><i class="fa fa-sticky-note-o" aria-hidden="true"></i> Star Register </a>
</span>
<span class="btn btn-primary btn-flat">
    <a href="<?= base_url('rcsa-context/edit/' . $id); ?>" target="_blank" style="color:#ffffff;" title=""><i class="fa fa-sticky-note-o" aria-hidden="true"></i> Star Risk Context </a>
</span>

...
<span class="btn btn-info btn-flat">
    <a href="<?= base_url('rcsa/propose/' . $id); ?>" target="_blank" style="color:#ffffff;" title="klik submit jika sudah melalkukan perbaikian"><i class="fa fa-check-circle-o" aria-hidden="true"></i> Submit </a>
</span>
<span class="btn btn-warning btn-flat">
    <a href="<?= base_url('rcsa/risk-event/' . $owner_no . '/' . $id); ?>" target="" style="color:#ffffff;" title=""><i class="fa fa-sticky-note-o" aria-hidden="true"></i> Start Register </a>
</span>
<span class="btn btn-primary btn-flat">
    <a href="<?= base_url('rcsa-context/edit/' . $id); ?>" target="_blank" style="color:#ffffff;" title=""><i class="fa fa-sticky-note-o" aria-hidden="true"></i> Start Risk Context </a>
</span>
    ...
    <table class="table table-bordered table-sm" id="datatables_event" border="1">
        <thead>
            ...
            <tr>
                ...
                <th colspan="4"><label>Perlakuan Risiko</label></th>
            </tr>
            <tr>

...
<table class="table" id="instlmt_impacy_x"><thead><tr>
...
<center>
	<button id="add_event_impact" class="btn btn-primary" type="button" value="Add More" name="add_event_impact" syle="margin-bottom:20px;"> <i class="fa fa-plus"></i> </button>
	<hr>
</center>

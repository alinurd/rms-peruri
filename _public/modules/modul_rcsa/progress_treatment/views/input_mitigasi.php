...
<div class="row">
	<div class="form-group clearfix">
		<label class="col-sm-3 control-label text-left"><?= lang('msg_field_proaktif'); ?>sasasas</label>
	...
	<div class="x_footer">
		<ul class="nav navbar-right panel_toolbox">
			<li><span class="btn btn-primary pointer" id="simpan_mitigasi"> Simpan </span></li>

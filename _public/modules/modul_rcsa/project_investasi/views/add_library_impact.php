<div class="modal-header">
  ...
  <h4 class="modal-title">ADD RISK IMPACT LIBRARY</h4>
</div>
<div class="modal-body">
	...
	<ul class="nav nav-tabs">
		<li>
			<a data-toggle="tab" href="#new_couse">Add New Impact</a>
		</li>
		<li class="active">
		...
		<div id="new_couse" class="tab-pane">
			...
			<table class="table data" id="datatables_librari">
				<tr>
					...
					<td style="width:15%;"><strong>IMPACT Library</strong>
					<input type="hidden" id="add_type_library" name="add_type_library" value="3">
...
<script type="text/javascript">
	$("#proses_quit, #proses_close,#proses_quit_db, #proses_close_db").click(function(){
		var url='<?php echo base_url("project/save-add-library-impact");?>';
		var mode=$(this).val();

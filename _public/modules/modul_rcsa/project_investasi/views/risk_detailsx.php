...
<div class="panel-body margin-bottom-15">
	<div class="tab-content">
		<div id="home" class="tab-pane active">
			<?php  echo form_open_multipart(base_url('project/save_detail/1'),array('id'=>'form_input'));?>
			<div id="content_detail">
				...
				<div class="box-body">
					...
					<a class="add btn btn-primary btn-flat" data-content="Add New Data" data-toggle="popover" href="<?php echo base_url('project/risk-event/1');?>

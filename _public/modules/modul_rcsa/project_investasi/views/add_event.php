...
<div class="panel-body">
  <div class="tab-content">
	  <div id="home" class="tab-pane active">
		<?php  
			echo form_open_multipart(base_url('project/save_detail'),array('id'=>'form_input'));
		?>
					...
					<tbody>
						<tr>
							...
							<td class=" no-border">
								...
								<?php 
									echo form_textarea("risk_area", ""," class='form-control text-left' rows='2' cols='5' readonly='' style='overflow: hidden; width: 80% !important; height: 75px;' id='risk_area' ")."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
								?>
...
<script>
	...
	$("#browse_area").click(function(){
		...
		var count=1;
		get_data_source(nil, tbl, count, parent);
	});

...
<table class="table table-bordered hide">
	<tr style="background:#0B2161 !important; color: white">
		...
		<td><button class="btn btn-sm btn-info propose pull-right" style="right:10px; top:13px;">PROPOSE</button>		
		</td>
	</tr>
</table>
...
<table class="table table-bordered">
	<tr style="background:#0B2161 !important; color: white">
		...
		<td>
		<button class="btn btn-sm btn-info propose pull-right" style="right:10px; top:13px;">PROPOSE</button>
		</td>
	</tr>
	<tr>
		<td colspan="23">

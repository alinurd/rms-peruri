...
class Data extends MX_Model {
    ...
    function getMonthlyMonitoringGlobal($q, $month)
	{
        ...
        $monthbefore        = $data['before'];
         if (!$monthbefore && $month !=1 && $monthly!=null) {
           ...
           <i class="fa fa-arrow-up bg-danger" aria-hidden="true"></i>
                <i class="fa fa-arrows-h bg-primary" aria-hidden="true"></i>
                <i class="fa fa-arrow-down bg-success" aria-hidden="true"></i>
                <div style="text-align: center; margin-bottom: 10px;">
             
                <br>
                    <span id="targetResidualLabel'.$q['id'].$month. '">
                        <span class="btn" style="display: inline; width: 50%; background-color: ' . $monthly['warna_action'] . '; color: ' . $monthly['warna_text_action'] . '; padding: 4px 8px;">
                            ' . $monthly['inherent_analisis_action'] . '
                        </span>
                        <span class="btn bg-danger" style="display: inline; width: 50%;; padding: 4px 8px;">
                            <i class="fa fa-arrow-up text-white " aria-hidden="true"></i>
                        </span>
                    </span>
                     <br>
                     <br>
          <textarea name="" id="" rows="1" cols="2" style="width: 100%;"></textarea>
                </div>
         
                <br>
                  <center><span class="btn btn-primary text-white" id="simpan_realisasi_'.$q['id'].'" data-month="'.$month.'" data-id="'.$q['id'].'">

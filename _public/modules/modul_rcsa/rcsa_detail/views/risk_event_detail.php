<?php  echo $judul;var_dump($cbo_owner);
die();
?>
				 ...
				 <section class="panel">
					<div class="panel-body no-padding">
						<div class="tree" style="overflow: scroll;height:500px;">
							<ul>
								<li>
									<span><i class="fa fa-folder-open"></i> List Event List</span>
									<ul style="padding-left:30px;">
										<li class="event"><span>Child</span></li>
										<li class="event"><span>Child</span></li>
										<li class="event"><span>Child</span></li>
										<li class="event"><span>Child</span></li>
										<li class="event"><span>Child</span></li>
...
<script>
	$("li.event").click(function(){
		var form = {idmodal:1}; 
		var url='<?php echo base_url("rcsa/get_detail_risk");?>';

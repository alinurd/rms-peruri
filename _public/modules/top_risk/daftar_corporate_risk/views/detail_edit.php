    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="hidden" name="id_detail" value="<?= $field[0]['id'];?>">
                <?= form_dropdown('event_no', $cboper, ($selected) ? $selected : '', 'class="select2 form-control" style="width:100%;" id="event_no"'); ?>
            </div>
        </div>
        <div class="col-md-6 text-right">
            <div class="form-group" style="margin-top: 25px;"> <!-- Atur margin untuk sejajar -->
                <button type="button" id="simpan_event_name" class="btn btn-info btn-flat">
                    <i class="fa fa-check-circle-o" aria-hidden="true"></i> Simpan
                </button>
            </div>
        </div>
    </div>
</form>
<div class="double-scroll" style='height:400px;'>
        ...
        <div class="col-md-12">
            <table class="table">
                <thead>
                    <tr>
                        <th width="5%">No.</th>
                        <th width="25%" class="text-left"> Event Name</th>
                ...
                <tbody>
                    ...
                    $no = 0;
                    foreach ($log as $row) : 
                        $data_lib = $this->db->where('id', $row['event_no'])->get(_TBL_LIBRARY)->row_array();
                    ?>
                        <tr>
                            <td class="text-center"><?= ++$no; ?></td>
                            <td><?= $data_lib['description']; ?></td>

        ...
        <section class="x_panel">
            ...
            <div class="x_content" style="overflow-x: auto;">
                <table class="table">
                    ...
                    <tr><td><em>Risk Agent</em></td><td><?= $parent['name']; ?></td></tr>
                    <tr><td><em>Periode</em></td><td><?= $parent['name']; ?></td></tr>
                    <tr><td><em>Anggaran RKAP</em></td><td><?= $parent['name']; ?></td></tr>
                </table>
            </div>
        </section>
    </div>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <button class="btn btn-success pull-right" data-id="<?= $parent['id']; ?>" id="cmdRisk_Register"> <?= lang('msg_field_risk_register'); ?> </button>

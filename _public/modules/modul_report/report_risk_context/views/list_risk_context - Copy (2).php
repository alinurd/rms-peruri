...
<tbody>
  <tr>
    ...
    <td colspan="4" style="background-color: #BFBFBF;text-align: center;">Konteks</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="2" style="background-color: #BFBFBF;text-align: center;">Kebijakan</td>
  </tr>
<?php
if (count($field) == 0)
echo '<tr><td colspan=23 style="text-align:center">No Data</td></tr>';
...
?>
  <tr>
    <td></td>
    <td valign="top" colspan="3"><?= $rows['sasaran']; ?></td>
    <td valign="top" colspan="2"><?= $rows['strategi']; ?></td>
    <td valign="top" colspan="2"><?= $rows['kebijakan']; ?></td>
  </tr>
<?php 
}
?>
...
?>
  ...
  <tr>
    <td colspan="8" style="border: none;">B.Isu Internal</td>
  </tr>
</thead>
<tbody>
  <tr>

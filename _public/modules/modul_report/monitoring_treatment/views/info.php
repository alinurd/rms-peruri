	...
	<div class="col-md-12">
		<div class="row">
			<div class="col-sm-8 panel-heading">
				<h3 style="padding-left:10px;">Monitoring Treatment</h3>
			</div>
			<div class="col-sm-4" style="text-align:right">
				<ul class="breadcrumb">
					<li> <a href="#"> <i class="fa fa-home"></i> Home</a></li>
					<li><a href="#">Monitoring Treatment</a></li>
				</ul>
			</div>
		</div>
	</div>
...
<!-- 				<div class="col-md-3 col-sm-3 col-xs-3">Risk Context</div>
				...
				<div class="col-md-9 col-sm-9 col-xs-9">
					<div class="form-group form-inline">
						<?=form_dropdown('bulan2', $bulan, date('n'), ' class="form-control select2" id="bulan2" style="width:100%;"');?>
					</div>
				</div> -->
					...
					<div id="option" style="display:none;">
						<table width="100%">
							<tr>
								...
								<td>
									<div class="form-group form-inline"> 
										<?=form_input('title_text', 'Pelaksanaan Treatment', ' class="form-control" id="title_text" style="width:100%;"');?>
									</div></td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								...
								<td>
									<div class="form-group form-inline"> 
										Type : 
										<?=form_dropdown('type_chart', ['bar'=>'Bar','horizontalBar'=>'Bar Horizontal']
										, 'horizontalBar', ' class="form-control select2" id="position_label" style="width:75%;"');?>
									</div>
								</td>
						</table>
					</div>

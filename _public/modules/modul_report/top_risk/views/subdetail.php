    ...
    <table class="table table-bordered table-hover">
        ...
        ?>
                <tr>
                    ...
                    <td><?= number_format($sub_row['target_progress_detail']) . '%'; ?></td>
            ...
            <td><?= ($realisasi['progress_detail']) ? number_format($realisasi['progress_detail']) . '%' : '<span class="text-danger">Belum dimonitoring</span>'; ?></td>
            <td><?= ($realisasi['target_progress_detail']) ? 'Rp. '.number_format($realisasi['target_progress_detail']) : '<span class="text-danger">Belum dimonitoring</span>'; ?></td>
            <td><?= ($realisasi['tanggal_monitoring']) ? $realisasi['tanggal_monitoring'] : '<span class="text-danger">belum dimonitoring</span>'; ?></td>

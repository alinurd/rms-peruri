...
{
    function news_url($value='')
    {
        $CI =& get_instance();
        return base_url()  . 'themes/' . $CI->config->item('news_path') . $value;
    }
}
...
if ( ! function_exists('regulasix_url'))
{
    function regulasix_url($value='')
    {
        $CI =& get_instance();
        return base_url()  . 'themes/file' . $CI->config->item('regulasix_path') . $value;
    }
}
...
if ( ! function_exists('backup_url'))
{
    function backup_url($value='')
    {
        $CI =& get_instance();
        return base_url()  . 'themes/' . $CI->config->item('backup_path') . $value;
    }
}
...
{
    function news_path($value='')
    {
        $CI =& get_instance();
        return FCPATH . 'themes/' . $CI->config->item('news_path') . $value;
    }
}
...
{
    function backup_path($value='')
    {
        $CI =& get_instance();
        return FCPATH . 'themes/' . $CI->config->item('backup_path') . $value;
    }
}
 ...
 if ( ! function_exists('staft_path_relative'))
{
 ...
 if ( ! function_exists('news_path_relative'))
{
    function news_path_relative($value='')
    {
        $CI =& get_instance();
        // doi::dump($CI);
...
if ( ! function_exists('regulasix_path_relative'))
{
    function regulasix_path_relative($value='')
    {
        $CI =& get_instance();
        return './' . 'themes/' . $CI->config->item('regulasix_path') . $value;
    }
}
...
if ( ! function_exists('backup_path_relative'))
{
    function backup_path_relative($value='')
    {
        $CI =& get_instance();
        return './' . 'themes/' . $CI->config->item('backup_path') . $value;
    }
}
